...
def generate_search_queries_prompt(question, max_iterations=5):
    ...
    return (
        f'Write {max_iterations} google search queries always using the language of the question to search online that form an objective opinion from the following: "{question}"'
...
def generate_report_prompt(question, context, report_format="apa", total_words=1000):
    ...
    return (
        ...
        "You must write the report in the language of the question",
        f"Use an unbiased and academic tone. \n"
...
def generate_custom_report_prompt(
    query_prompt, context, report_format="apa", total_words=1000
):
    return f'"{context}"\n\n{query_prompt}'
